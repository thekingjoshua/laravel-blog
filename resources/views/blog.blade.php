...
<body>
                            ...
                            <div class="d-flex hover-up-2 transition-normal">
                                <div class="post-thumb post-thumb-80 d-flex mr-15 border-radius-5 img-hover-scale overflow-hidden">
                                    <a class="color-white" href="single.html">
                                        <img src="{{asset('imgs/news/thumb-1.jpg')}}" alt="">
                                    </a>
                                </div>
            ...
            <div class="container">
                <div class="row pt-20 pb-20">
                    ...
                    <div class="col-md-9 col-xs-6 text-right header-top-right ">
                        ...
                        <button class="btn btn-radius bg-primary text-white ml-15 font-small box-shadow">Register</button>
                        <button class="btn btn-radius bg-primary text-white ml-15 font-small box-shadow">Login</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="featured-slider-2-items">
                <div class="slider-single">
                    <div class="post-thumb position-relative">
                        <div class="thumb-overlay position-relative" style="background-image: url({{asset('imgs/news/news-16.jpg')}})">
    ...
    <!-- Vendor JS-->
    <script src="{{asset('js/vendor/modernizr-3.6.0.min.js')}} ./assets/"></script>
    ...
    <script src="{{asset('js/vendor/jquery.ticker.js')}}"></script>
    <script src="{{asset('js/vendor/jquery.vticker-min.js')}}"></script>
    <script src="{{asset('js/vendor/jquery.scrollUp.min.js')}}"></script>
    <script src="{{asset('js/vendor/jquery.nice-select.min.js')}}"></script>
    <script src="{{asset('js/vendor/jquery.magnific-popup.js')}}"></script>
